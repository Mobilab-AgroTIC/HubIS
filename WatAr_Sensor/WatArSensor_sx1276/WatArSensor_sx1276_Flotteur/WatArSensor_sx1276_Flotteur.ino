...
#define TTN_DEVEUI { 0x8B, 0xC1, 0x04, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 } // TTN Device EUI with "lsb"
#define TTN_APPKEY { 0x42, 0xA6, 0x19, 0x61, 0x3C, 0x7D, 0xD1, 0x83, 0xCE, 0xF6, 0xFE, 0xB3, 0xFD, 0x89, 0x0B, 0x20 } // TTN App Key with "msb"

static uint8_t LORA_DATA[1];
static osjob_t sendjob;
const unsigned TX_INTERVAL = 160;
