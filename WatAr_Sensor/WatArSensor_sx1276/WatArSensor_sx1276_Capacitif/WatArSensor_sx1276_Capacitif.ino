//La résistance doit être au moins de 100kOhm pour que le capteur fonctionne 7 mois. 8mois avec 1 MOhm.
#include <lmic.h>
#include <hal/hal.h>
#include <SPI.h>
#include <avr/sleep.h> 
...
#define TTN_DEVEUI { 0x82, 0xC1, 0x04, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 } // TTN Device EUI with "lsb"
#define TTN_APPKEY { 0x4B, 0x10, 0x45, 0xE3, 0xF1, 0xDE, 0x1E, 0xF7, 0xFF, 0x59, 0x81, 0xF1, 0x3A, 0x82, 0x89, 0x89 } // TTN App Key with "msb"

static uint8_t LORA_DATA[1];
static osjob_t sendjob;
const unsigned TX_INTERVAL = 24;
...
void LoRaWANGetData()
{
    ...
    delay(500);
    int val = analogRead(SENSOR_PIN)/4;
    Serial.print('Val : ');
    Serial.println(val);
    LORA_DATA[0] = val;
